...
static const _BBoxes_type_support_symbol_names_t _BBoxes_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msgs_bbox, msg, BBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgs_bbox, msg, BBoxes)),
  }
};
...
{
  return &::msgs_bbox::msg::rosidl_typesupport_cpp::BBoxes_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msgs_bbox, msg, BBoxes)() {
  return get_message_type_support_handle<msgs_bbox::msg::BBoxes>();
}
