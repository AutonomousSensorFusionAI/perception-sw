...
bool msgs_bbox__msg__b_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msgs_bbox.msg._b_box.BBox", full_classname_dest, 25) == 0);
  }
  msgs_bbox__msg__BBox * ros_message = _ros_message;
  {  // cls
...
PyObject * msgs_bbox__msg__b_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msgs_bbox.msg._b_box");
